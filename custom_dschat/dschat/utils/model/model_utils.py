...
from dschat.utils.model.reward_model import RewardModel, UltraRewardModel
...
def create_hf_model(model_class,
    ...
    if "LlamaGuard-7b" in model_name_or_path:
...
def create_critic_model(model_name_or_path,
    ...
    if "Ultra" in model_name_or_path:
        print("Using UltraRewardModel......")
        critic_model = UltraRewardModel.from_pretrained(model_name_or_path)
    else:
